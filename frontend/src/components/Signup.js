      ...
      <div className="signup-card">
        <div className="logo-section">
          <div className="logo-icon-large">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2C6.48 2 2 6.48 2 12C2 13.93 2.6 15.72 3.63 17.19L2.05 21.95L6.93 20.4C8.36 21.37 10.1 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2Z" fill="url(#logo-gradient-signup)"/>
              <defs>
                <linearGradient id="logo-gradient-signup" x1="2" y1="2" x2="22" y2="22">
        ...
        <p className="signup-subtitle">Join us and start secure conversations</p>
        ...
        <p className="signup-login-link">
          Already have an account? <Link to="/" className="link-highlight">Login</Link>
        </p>
      </div>
    </div>
  );
